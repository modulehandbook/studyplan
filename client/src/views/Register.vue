<template>
  <div>
    ...
    <h2 v-if="!successful">Disclaimer: Diesen Service zu nutzen hat keine weiteren Auswirkungen auf dein Studium und ist somit komplett freiwillig. <br /> Deine angegebenen Daten werden sowohl in unserer Datenbank, als auch lokal bei dir gespeichert.</h2>
